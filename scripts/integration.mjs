...
const dogfoodWorkspace = path.join(root, "tests", "dogfood", "proof-project");
...
await runTests({
  ...
  extensionTestsPath,
  launchArgs: ["--disable-gpu", "--disable-extensions-except", extensionDevelopmentPath, dogfoodWorkspace],
});
